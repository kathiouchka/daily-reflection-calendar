  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-start pt-4 sm:pt-8 md:pt-12">
      ...
      <div className="w-full max-w-full sm:max-w-2xl md:max-w-3xl bg-white dark:bg-slate-800 rounded-2xl md:rounded-3xl shadow-xl md:shadow-2xl dark:shadow-2xl overflow-hidden border border-slate-200 dark:border-slate-700 p-4 sm:p-8 md:p-16 transition-colors duration-200">
        ...
        {successMessage && (
          <div className="success-message mb-12 p-8 bg-green-100 dark:bg-green-700/30 text-green-700 dark:text-green-200 rounded-xl text-2xl">
            <p className="flex items-center">
              <svg className="h-8 w-8 mr-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
        ...
        {error && (
          <div className="mb-12 p-8 bg-red-100 dark:bg-red-800/60 text-red-700 dark:text-red-200 rounded-xl text-2xl">
            <p className="flex items-center">
              <svg className="h-8 w-8 mr-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div className="mt-20 text-center">
          <Link 
            ...
            className="text-indigo-600 hover:text-indigo-700 dark:text-indigo-400 dark:hover:text-indigo-300 font-bold flex items-center justify-center gap-4 text-3xl transition-colors duration-200"
          >
