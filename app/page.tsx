  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6">
      ...
      <div className="w-full max-w-lg bg-white dark:bg-slate-800 rounded-2xl shadow-xl dark:shadow-lg overflow-hidden border border-slate-200 dark:border-slate-700 p-8 transition-colors duration-200">
        ...
        {successMessage && (
          <div className="success-message mb-8 p-6 bg-green-100 dark:bg-green-700/30 text-green-700 dark:text-green-200 rounded-lg">
        ...
        {error && (
          <div className="mb-8 p-6 bg-red-100 dark:bg-red-800/60 text-red-700 dark:text-red-200 rounded-lg">
            <p className="flex items-center">
              <svg className="h-5 w-5 mr-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div className="mt-12 text-center">
          <Link 
            ...
            className="text-indigo-600 hover:text-indigo-700 dark:text-indigo-400 dark:hover:text-indigo-300 font-medium flex items-center justify-center gap-2 transition-colors duration-200"
          >
